...
import { Text, View, TextInput, Pressable, Modal, Alert, StyleSheet } from 'react-native';
      ...
      <View>
        <View>
          <View className='z-10 self-start mt-4 ml-2 bg-background'>
            <Text className="text-purple-3 px-1.5 text-xs font-kiwi-maru">Full Name</Text>
          </View>
          <View className='flex-row items-center justify-between px-4 -mt-2 py-2 border border-purple-3 rounded-2'>
            <TextInput className="text-white placeholder:text-white" placeholder="Name, Last Name" />
          </View>
        </View>
        <View>
          <Modal
          ...
          <View className='z-10 self-start mt-4 ml-2 bg-background'>
          <Text className="text-purple-3 px-1.5 text-xs font-kiwi-maru">Birthday</Text>
          </View>
          <Pressable className='flex-row items-center justify-between px-4 -mt-2 py-2 border border-purple-3 rounded-2' onPress={() => openModal()}>
            <Text
        ...
        <View>
          <View className='z-10 self-start mt-4 ml-2 bg-background'>
            <Text className="text-purple-3 px-1.5 text-xs font-kiwi-maru">Gender</Text>
          </View>
