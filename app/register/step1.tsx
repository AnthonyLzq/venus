...
export default function Step1() {
  ...
  return (
    <RegisterLayout>
      ...
      <View>
        <View>
          ...
          <View className='flex-row items-center justify-between px-4 -mt-2 py-2 border border-purple-3 rounded-2'>
            <TextInput className="text-white" placeholder="Name, Last Name" />
          </View>
        </View>
        <View>
          <View className='z-10 self-start mt-4 ml-2 bg-background'>
          <Text className="text-purple-3 px-1.5 text-xs font-kiwi-maru">Age</Text>
          </View>
          <View className='flex-row items-center justify-between px-4 -mt-2 py-2 border border-purple-3 rounded-2'>
            <TextInput className=" text-white" keyboardType='numeric' />
      ...
      <ButtonLinearGradient onPress={goToStep2} className='mt-[33%] self-center'>
